 ...
 */
public class EHFNamespacePrefixMapper extends NamespacePrefixMapper {

    private static EHFNamespacePrefixMapper instance;
    private Map<String, String> uriPrefixMap = null;
    private List<String> defaultNSUri = null;

    private EHFNamespacePrefixMapper() {
        init();
    }

    public static synchronized EHFNamespacePrefixMapper getInstance() {
        if (instance == null) {
            instance = new EHFNamespacePrefixMapper();
        }
        return instance;
    }
